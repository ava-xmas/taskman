...
from ..views import SendFriendRequestAPIView, AcceptFriendRequestAPIView, RejectFriendRequestAPIView, PendingFriendRequestsAPIView, GetFriends
...
urlpatterns = [
    ...
    path('get/', GetFriends.as_view(), name='get-accepted-friends'),
]
